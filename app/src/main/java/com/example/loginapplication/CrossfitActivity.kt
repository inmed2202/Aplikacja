...
import com.example.loginapplication.databinding.ActivityCrossfitBinding
...
class CrossfitActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityCrossfitBinding.inflate(layoutInflater)
        setContentView(binding.root)

        binding.crossfitzapisBtn.setOnClickListener {
    ...
    private fun addEventToCalendar() {
        ...
        values.put(CalendarContract.Events.TITLE, "Crossfit")
